...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет урон, нанесенный противнику при атаке."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет количество блокированного урона при защите."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Активирует применение специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает тренировку управления навыками."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Определяет выбор игрового персонажа."""
    approve_choice = None
    char_class = None
